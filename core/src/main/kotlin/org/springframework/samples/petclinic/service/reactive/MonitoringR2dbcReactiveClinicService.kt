...
class MonitoringR2dbcReactiveClinicService(
    ...
    override fun sleepAndFetchWithDb(times: Int, sleep: Boolean, millis: Int, strings: Int, length: Int, jooq: Boolean): Mono<List<String>> = recordTimer("sleepAndFetchWithDb", service.sleepAndFetchWithDb(times, sleep, millis, strings, length, jooq))
    override fun sleepAndFetchWithoutDb(times: Int, sleep: Boolean, millis: Int, strings: Int, length: Int): Mono<List<String>> = recordTimer("sleepAndFetchWithoutDb", service.sleepAndFetchWithoutDb(times, sleep, millis, strings, length))
}
