    ...
    scenarios: {
        petclinic: {
            ...
            stages: [
                ...
                // It should linearly ramp-up to 'target' iterations per `timeUnit` over the following `duration`.
                { target: 520, duration: '20s' },
                // It should stay at `target` iterations per `timeUnit` for the following `duration`.
                { target: 520, duration: '20s' },

                // It should linearly ramp-up to 'target' iterations per `timeUnit` over the following `duration`.
                { target: 540, duration: '20s' },
                // It should stay at `target` iterations per `timeUnit` for the following `duration`.
                { target: 540, duration: '20s' },

                // It should linearly ramp-up to 'target' iterations per `timeUnit` over the following `duration`.
                { target: 560, duration: '20s' },
                // It should stay at `target` iterations per `timeUnit` for the following `duration`.
                { target: 560, duration: '20s' },

                // It should linearly ramp-up to 'target' iterations per `timeUnit` over the following `duration`.
                { target: 580, duration: '20s' },
                // It should stay at `target` iterations per `timeUnit` for the following `duration`.
                { target: 580, duration: '20s' },
                ...
                // It should linearly ramp-up to 'target' iterations per `timeUnit` over the following `duration`.
                { target: 620, duration: '20s' },
                // It should stay at `target` iterations per `timeUnit` for the following `duration`.
                { target: 620, duration: '20s' },

                // It should linearly ramp-up to 'target' iterations per `timeUnit` over the following `duration`.
                { target: 640, duration: '20s' },
                // It should stay at `target` iterations per `timeUnit` for the following `duration`.
                { target: 640, duration: '20s' },

                // It should linearly ramp-up to 'target' iterations per `timeUnit` over the following `duration`.
                { target: 660, duration: '20s' },
                // It should stay at `target` iterations per `timeUnit` for the following `duration`.
                { target: 660, duration: '20s' },

                // It should linearly ramp-up to 'target' iterations per `timeUnit` over the following `duration`.
                { target: 680, duration: '20s' },
                // It should stay at `target` iterations per `timeUnit` for the following `duration`.
                { target: 680, duration: '20s' },
                ...
                // It should linearly ramp-up to 'target' iterations per `timeUnit` over the following `duration`.
                { target: 720, duration: '20s' },
                // It should stay at `target` iterations per `timeUnit` for the following `duration`.
                { target: 720, duration: '20s' },

                // It should linearly ramp-up to 'target' iterations per `timeUnit` over the following `duration`.
                { target: 740, duration: '20s' },
                // It should stay at `target` iterations per `timeUnit` for the following `duration`.
                { target: 740, duration: '20s' },

                // It should linearly ramp-up to 'target' iterations per `timeUnit` over the following `duration`.
                { target: 760, duration: '20s' },
                // It should stay at `target` iterations per `timeUnit` for the following `duration`.
                { target: 760, duration: '20s' },

                // It should linearly ramp-up to 'target' iterations per `timeUnit` over the following `duration`.
                { target: 780, duration: '20s' },
                // It should stay at `target` iterations per `timeUnit` for the following `duration`.
                { target: 780, duration: '20s' },
