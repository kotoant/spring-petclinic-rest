...
--changeset Anton.Kotov:data runAlways:true runOnChange:true endDelimiter:\ contextFilter:data
TRUNCATE vets RESTART IDENTITY CASCADE\
TRUNCATE specialties RESTART IDENTITY CASCADE\
TRUNCATE vet_specialties RESTART IDENTITY CASCADE\
TRUNCATE types RESTART IDENTITY CASCADE\
TRUNCATE owners RESTART IDENTITY CASCADE\
TRUNCATE pets RESTART IDENTITY CASCADE\
TRUNCATE visits RESTART IDENTITY CASCADE\
